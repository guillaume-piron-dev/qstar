...
with gr.Blocks() as demo:
    ...
    with gr.Row():
        prompt_input = gr.Textbox(label="Prompt utilisateur", placeholder="Ex: Quels sont les effets du changement climatique ?")
        response_input = gr.Textbox(label="Réponse du modèle", placeholder="Ex: Le changement climatique entraîne...")
